...
export class ObservableDeviceApi {
     ...
     */
    public setDeviceToken(deviceTokenDto: DeviceTokenDto, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.setDeviceToken(deviceTokenDto, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.setDeviceToken(rsp)));
            }));
    }
     ...
     */
    public setStatus(deviceStatusDto: DeviceStatusDto, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.setStatus(deviceStatusDto, _options);
